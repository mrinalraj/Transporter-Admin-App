            ...
            <Card style={{ marginBottom: Dimens.padding / 2 }} onPress={this.props.onPress}>
                ...
                <Card.Content>
                    <View style={{ flexDirection: "row" }}>
                        ...
                        <View style={{ flexDirection: 'column', borderLeftColor: Colors.muteTextColor, borderLeftWidth: 1, flex: 0.5 }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', padding: 20, }}>
                                <Image style={{ height: 35.5, width: 50, marginEnd: 15 }} source={require('../../assets/truck.png')} />
