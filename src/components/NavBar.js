...
const NavBar = props => {
    return (
        <View>
            ...
            <View style={{
                flexDirection: 'row', padding: Dimens.wp('2'), alignItems: 'center', paddingLeft: Dimens.padding / 4, paddingRight: Dimens.padding / 4, justifyContent: 'space-between', backgroundColor: Colors.primaryColor
            }}>
